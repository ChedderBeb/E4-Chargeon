...
{
	partial class UserControlBornes
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lvBornes = new System.Windows.Forms.ListView();
			this.IdBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.NumSerieBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.TypeBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.RefBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.PuissanceBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.ConcuBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.LatBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.LongBornes = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.lvBornes);
			...
			// lvBornes
			// 
			this.lvBornes.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.IdBornes,
            this.NumSerieBornes,
            this.TypeBornes,
            this.RefBornes,
            this.PuissanceBornes,
            this.ConcuBornes,
            this.LatBornes,
            this.LongBornes});
			this.lvBornes.Location = new System.Drawing.Point(7, 7);
			this.lvBornes.Name = "lvBornes";
			this.lvBornes.Size = new System.Drawing.Size(625, 230);
			this.lvBornes.TabIndex = 20;
			this.lvBornes.UseCompatibleStateImageBehavior = false;
			this.lvBornes.View = System.Windows.Forms.View.Details;
			// 
			// IdBornes
			// 
			this.IdBornes.Text = "Id";
			// 
			// NumSerieBornes
			// 
			this.NumSerieBornes.Text = "Numéro de série";
			// 
			// TypeBornes
			// 
			this.TypeBornes.Text = "Type";
			// 
			// RefBornes
			// 
			this.RefBornes.Text = "Référence";
			// 
			// PuissanceBornes
			// 
			this.PuissanceBornes.Text = "Puissance";
			// 
			// ConcuBornes
			// 
			this.ConcuBornes.Text = "Concurrence";
			// 
			// LatBornes
			// 
			this.LatBornes.Text = "Latitude";
			// 
			// LongBornes
			// 
			this.LongBornes.Text = "Longitude";
			this.LongBornes.Width = 99;
			// 
			// UserControlBornes
			// 
		...
		private System.Windows.Forms.ListView lvBornes;
		private System.Windows.Forms.ColumnHeader IdBornes;
		private System.Windows.Forms.ColumnHeader NumSerieBornes;
		private System.Windows.Forms.ColumnHeader TypeBornes;
		private System.Windows.Forms.ColumnHeader RefBornes;
		private System.Windows.Forms.ColumnHeader PuissanceBornes;
		private System.Windows.Forms.ColumnHeader ConcuBornes;
		private System.Windows.Forms.ColumnHeader LatBornes;
		private System.Windows.Forms.ColumnHeader LongBornes;
	}
}
